...
namespace JoseCerezo_Taller1.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(JoseCerezo_Taller1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Ciudad,Capacidad")] EstadioModel estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Ciudad,Capacidad")] EstadioModel estadio)
        {
            if (id != estadio.Id)
            {
                return NotFound();
